<html>
    ...
    <div class="registercontainer">
        <form name="form1" action="registerLogic.php" method="post" enctype="multipart/form-data">
            ...
            <p>Birth place</p>
            <input type="text" name="placeofbirthpatient" placeholder="birth place">

            <p>Birth date</p>
            <input type="date" name="dateofbirthpatient">

            <p>Street</p>
            <input type="text" name="streetnamepatient" placeholder="street">

            <p>House number</p>
            <input type="number" name="housenumberpatient" placeholder="house number">

            <p>Place</p>
            <input type="text" name="townpatient" placeholder="place">
            <p>E-mail adress</p>
